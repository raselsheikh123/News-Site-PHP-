...
$item_per_page = 3;
$total_records = mysqli_num_rows( mysqli_query($conn, "SELECT * FROM post WHERE title LIKE '%$search_term%'"));
                ...
                <div class="post-container">
                  <h2 class="page-heading">Search : <?php echo $search_term; ?></h2>
                    ...
                    <ul class='pagination'>
                        ...
                        if ($current_page > 1){
                            ?>
                            <li><a href='?search=<?php echo $search_term; ?>&page=<?php echo $current_page - 1; ?>'>Prev</a></li>
                            <?php
                        }
                        ?>
                        <?php
                        for ($x = 1; $x <= $total_pages; $x++) {
                            ...
                            echo "<li class='{$active}'><a href='?search={$search_term}&page={$x}'>$x</a></li>";
                        }
                        ?>
                        <?php if ($current_page < $total_pages) {
                            ?>
                            <li><a href='?search=<?php echo $search_term; ?>&page=<?php echo $current_page + 1; ?>'>Next</a></li>
                            <?php
                        }?>
                    </ul>
                </div><!-- /post-container -->
